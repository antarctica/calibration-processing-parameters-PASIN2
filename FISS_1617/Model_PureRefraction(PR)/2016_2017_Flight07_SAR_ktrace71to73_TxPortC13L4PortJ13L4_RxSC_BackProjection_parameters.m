...
azGrid = (710*pulsesPerBlock+1):az_pres*1:(731*pulsesPerBlock); % [samples], (index starts at 1)
...
lastRowIMUfile = '182640'; % row in 'IMUfile'
...
lastRowBotfile = 81226; % row in 'BotFile'
...
filterMigrationDC_flag = 1; % 0: no filter; 1: filter DC of BP samples
...
refractionAngleIterativeFlag = 1; % 0: small-angle aprox; 1: iterative methode
